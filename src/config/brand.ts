...
export const SOCIAL = {
  ...
  facebook: process.env.SOCIAL_FACEBOOK_URL || "https://www.facebook.com/share/1KbQUNLiF3/?mibextid=wwXIfr",
  tiktok: process.env.SOCIAL_TIKTOK_URL || "https://www.tiktok.com/@numastyle2025",
  instagram: process.env.SOCIAL_INSTAGRAM_URL || "https://www.instagram.com/numaci2025?igsh=N3N3M2VhY2F3ZzFm&utm_source=qr",
};
